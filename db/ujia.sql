...
INSERT INTO `re_house` (`hid`, `title`, `subtitle`, `price`, `space`, `shot_time`, `uid`, `house_room`, `house_hall`, `house_kitchen`, `house_toilet`, `side`, `is_lift`, `decoration`, `floor`, `building_type`, `ladder_ratio`, `property_year`, `house_type`) VALUES
(1, '天润城九街区 南北通透两房 交通方便 配套齐全', '此房电梯房，1楼有架空，南北通透，配套齐全，地铁口交通便利', '190.0000', '81.76', '提前预约随时可看', 2, '2', '2', '1', '1', '南 北', '1', '简装', '中楼层 (共11层)', '板楼', '一梯两户', 70, '0'),
(2, '南北通透 位置好环境美 配套完善 交通便利', '此房南北通透 采光充足 配套完善 交通便利 小区物业好环境优', '181.0000', '80.75', '提前预约随时可看', 2, '2', '2', '1', '1', '南 北', '1', '精装', '低楼层 (共6层)', '板楼', '一梯两户', 70, '0'),
(3, '托乐嘉友邻居 30万精装 拎包入住 满五唯一 地铁口', '此房满五年唯一，采光很好，30万精装修，拎包入住，好楼层', '378.0000', '142.35', '提前预约随时可看', 3, '4', '2', '1', '2', '南 北', '1', '其他', '中楼层 (共10层)', '塔楼', '一梯两户', 70, '0'),
(4, '三开间朝南 新城双本 税费低 业主诚心出售 看房方便', '三开间朝南 新城双本 税费低 业主诚心出售 看房方便', '675.0000', '131.95', '提前预约随时可看', 3, '3', '2', '1', '2', '南 北', '1', '精装', '低楼层 (共11层)', '板楼', '一梯两户', 70, '0'),
(5, '婚房 精装修 有阳台 南北通透 2居 有电梯', '南北通透 视野宽阔 交通便利 拎包入住两居室 电梯房 婚装保养好', '230.0000', '87.05', '提前预约随时可看', 2, '2', '2', '1', '1', '南 北', '1', '精装', '中楼层 (共11层)', '板塔结构', '一梯两户', 70, '0'),
(6, '满五年无个税 户型好大三房 1号线胜太路3号线胜太西路', '南北通透 得房率高 交通方便 配套齐全 不临街', '245.0000', '94.20', '提前预约随时可看', 2, '2', '2', '1', '1', '南 北', '0', '简装', '低楼层 (共6层)', '板塔结构', '一梯两户', 70, '0'),
(7, '天润城第十一街区 品字户型 三开朝南', '此房品字户型，三开朝南，交通便利，出行方便', '172.0000', '68.22', '提前预约随时可看', 3, '2', '2', '1', '1', '南', '1', '精装', '中楼层 (共11层)', '板塔结构', '一梯三户', 70, '0'),
(8, '十街区 弘阳物业 三面朝南小三房 采光充', '此房南北通透 多层无浪费面积 中上楼视野开阔', '209.0000', '90.78', '提前预约随时可看', 3, '3', '2', '1', '1', '南 北', '1', '毛坯', '中楼层 (共6层)', '板楼', '一梯两户', 70, '0'),
(9, '万科金域东方', '两卧朝南 户型方正 南北通透', '211.0000', '90.00', '提前预约随时可看', 3, '2', '2', '1', '1', '南 北', '1', '精装', '中楼层 (共11层)', '板楼', '一梯两户', 70, '1'),
(10, '滟紫台', '主卧带卫 多卫 两卧朝南 户型方正', '957.0000', '290.00', '提前预约随时可看', 3, '4', '3', '3', '2', '南 北', '0', '毛坯', '联排别墅', '别墅', '别墅', 70, '1'),
(11, '融侨观邸', '南北通透、客厅朝南、主卧朝南、明厨、明卫、厨卫不对门', '280.0000', '106.00', '提前预约随时可看', 2, '3', '1', '1', '1', '南 北', '1', '毛坯', '中楼层 (共11层)', '板楼', '一梯两户', 70, '1'),
(12, '恒辉假日广场', '两卧朝南、主卧朝南、明厨、明卫、厨卫不对门', '250.0000', '106.00', '提前预约随时可看', 3, '3', '2', '1', '1', '南 北', '1', '毛坯', '中楼层 (共11层)', '板楼', '一梯两户', 70, '1'),
(13, '恒大翡翠华庭', '多阳台、主卧带卫、两卧朝南、客厅朝南、厨卫不对门', '736.0000', '230.00', '提前预约随时可看', 2, '5', '1', '1', '2', '南 北', '1', '毛坯', '中高楼层 (共25层)', '板楼', '一梯两户', 70, '1'),
(14, '中建国熙台', '厨卫不对门、户型方正、客厅朝南、两卧朝南、主卧朝南、主卧带卫、餐客', '498.0000', '166.00', '提前预约随时可看', 2, '5', '2', '1', '3', '南 北', '1', '毛坯', '中高楼层 (共18层)', '板楼', '一梯两户', 70, '1');
...
CREATE TABLE re_zufang(
  ...
  size                VARCHAR(32) NOT NULL DEFAULT '',      #面积
...
INSERT INTO `re_zufang` (`zid`, `uid`, `title`, `area`, `size`, `floor`, `metro`, `district`, `house_room`, `house_hall`, `house_kitchen`, `house_toilet`, `publish_time`, `price`, `side`, `people`) VALUES
(1, 2, '环境优美 随时看房 紧凑单室套 温馨入住', '江宁区', '49平米', '低楼层(共11层)', '距离S1机场线翠屏山站303米', '托乐嘉单身公寓', '1室', '1厅', '1厨', '1卫', '2017-12-02 00:00:00', '2300.00', '南', 18),
(2, 3, '一楼带院子 品牌家具 看房方便', '江宁区', '131平米', '低楼层(共6层)', '江宁 麒麟镇', '锦绣花园', '3室', '2厅', '1厨', '2卫', '2017-12-03 00:00:00', '3500.00', '南 北', 3),
(3, 2, '王府园小区 2室1厅 2800元', '秦淮区', '82平米', '低楼层(共11层)', '距离1号线张府园站768米', '王府园小区', '2室', '1厅', '1厨', '1卫', '2017-12-02 00:00:00', '2800.00', '南 北', 3),
(4, 3, '东郊小镇第八街区 2室1厅 1800元', '江宁区', '45平米', '低楼层(共9层)', '江宁 麒麟镇', '东郊小镇第八街区', '2室', '1厅', '1厨', '1卫', '2017-12-04 00:00:00', '1800.00', '东南', 1),
(5, 2, '丹佛单身公寓，拎包入住', '江宁区', '34平米', '中楼层(共9层)', '江宁 将军大道', '丹佛单身公寓', '1室', '1厅', '1厨', '1卫', '2017-10-02 00:00:00', '2200.00', '北', 8),
(6, 3, '文枢苑居家大三房 采光好 视野开阔 环境好 人文素质', '江宁区', '138平米', '低楼层(共11层)', '距地铁S1机场线河海大学.佛城西路813米', '江南文枢苑云泊居', '2室', '1厅', '1厨', '1卫', '2017-12-02 00:00:00', '4500.00', '南 北', 2);
